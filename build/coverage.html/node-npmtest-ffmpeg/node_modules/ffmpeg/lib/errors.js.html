...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ffmpeg/node_modules/ffmpeg/lib/errors.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-ffmpeg/node_modules/ffmpeg/lib/errors.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ffmpeg/node_modules/ffmpeg/lib/</a> &#187; errors.js</div>
</div>
<div class="body">
 ...
 */
var renderError = <span class="fstat-no" title="function not covered" >function (codeName) {</span>
	// Get the error object by the codename
<span class="cstat-no" title="statement not covered" >	var params = [list[codeName].msg];</span>
	// Get the possible arguments
<span class="cstat-no" title="statement not covered" >	if (arguments.length &gt; 1)</span>
<span class="cstat-no" title="statement not covered" >		params = params.concat(Array.prototype.slice.call(arguments, 1));</span>
	// Call the function for replace the letter '%s' with the found arguments
<span class="cstat-no" title="statement not covered" >	return { 'code' : list[codeName].code, 'msg' : util.format.apply(this, params) };</span>
}
&nbsp;
